...
`timescale 1 ps / 1 ps
module base_sys_mm_interconnect_1 (
		...
		input  wire        sys_mem_reset2_reset_bridge_in_reset_reset,  //  sys_mem_reset2_reset_bridge_in_reset.reset
	...
	wire  [89:0] nios2_cpu_debug_mem_slave_agent_rf_source_data;                                  // nios2_cpu_debug_mem_slave_agent:rf_source_data -> nios2_cpu_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [89:0] nios2_cpu_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_cpu_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_cpu_debug_mem_slave_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                               // cmd_mux:src_valid -> nios2_cpu_debug_mem_slave_agent:cp_valid
	wire  [88:0] cmd_mux_src_data;                                                                // cmd_mux:src_data -> nios2_cpu_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                               // nios2_cpu_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                             // cmd_mux:src_channel -> nios2_cpu_debug_mem_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                       // cmd_mux:src_startofpacket -> nios2_cpu_debug_mem_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                         // cmd_mux:src_endofpacket -> nios2_cpu_debug_mem_slave_agent:cp_endofpacket
	...
	wire  [89:0] sys_mem_s2_agent_rf_source_data;                                                 // sys_mem_s2_agent:rf_source_data -> sys_mem_s2_agent_rsp_fifo:in_data
	...
	wire  [89:0] sys_mem_s2_agent_rsp_fifo_out_data;                                              // sys_mem_s2_agent_rsp_fifo:out_data -> sys_mem_s2_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                           // cmd_mux_001:src_valid -> sys_mem_s2_agent:cp_valid
	wire  [88:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> sys_mem_s2_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                           // sys_mem_s2_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> sys_mem_s2_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                   // cmd_mux_001:src_startofpacket -> sys_mem_s2_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                     // cmd_mux_001:src_endofpacket -> sys_mem_s2_agent:cp_endofpacket
	wire         nios2_cpu_instruction_master_agent_cp_valid;                                     // nios2_cpu_instruction_master_agent:cp_valid -> router:sink_valid
	wire  [88:0] nios2_cpu_instruction_master_agent_cp_data;                                      // nios2_cpu_instruction_master_agent:cp_data -> router:sink_data
	wire         nios2_cpu_instruction_master_agent_cp_ready;                                     // router:sink_ready -> nios2_cpu_instruction_master_agent:cp_ready
	wire         nios2_cpu_instruction_master_agent_cp_startofpacket;                             // nios2_cpu_instruction_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire         nios2_cpu_instruction_master_agent_cp_endofpacket;                               // nios2_cpu_instruction_master_agent:cp_endofpacket -> router:sink_endofpacket
	wire         nios2_cpu_debug_mem_slave_agent_rp_valid;                                        // nios2_cpu_debug_mem_slave_agent:rp_valid -> router_001:sink_valid
	wire  [88:0] nios2_cpu_debug_mem_slave_agent_rp_data;                                         // nios2_cpu_debug_mem_slave_agent:rp_data -> router_001:sink_data
	wire         nios2_cpu_debug_mem_slave_agent_rp_ready;                                        // router_001:sink_ready -> nios2_cpu_debug_mem_slave_agent:rp_ready
	wire         nios2_cpu_debug_mem_slave_agent_rp_startofpacket;                                // nios2_cpu_debug_mem_slave_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         nios2_cpu_debug_mem_slave_agent_rp_endofpacket;                                  // nios2_cpu_debug_mem_slave_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire         sys_mem_s2_agent_rp_valid;                                                       // sys_mem_s2_agent:rp_valid -> router_002:sink_valid
	wire  [88:0] sys_mem_s2_agent_rp_data;                                                        // sys_mem_s2_agent:rp_data -> router_002:sink_data
	wire         sys_mem_s2_agent_rp_ready;                                                       // router_002:sink_ready -> sys_mem_s2_agent:rp_ready
	wire         sys_mem_s2_agent_rp_startofpacket;                                               // sys_mem_s2_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         sys_mem_s2_agent_rp_endofpacket;                                                 // sys_mem_s2_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         router_src_valid;                                                                // router:src_valid -> nios2_cpu_instruction_master_limiter:cmd_sink_valid
	wire  [88:0] router_src_data;                                                                 // router:src_data -> nios2_cpu_instruction_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                                // nios2_cpu_instruction_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [1:0] router_src_channel;                                                              // router:src_channel -> nios2_cpu_instruction_master_limiter:cmd_sink_channel
	wire         router_src_startofpacket;                                                        // router:src_startofpacket -> nios2_cpu_instruction_master_limiter:cmd_sink_startofpacket
	wire         router_src_endofpacket;                                                          // router:src_endofpacket -> nios2_cpu_instruction_master_limiter:cmd_sink_endofpacket
	wire  [88:0] nios2_cpu_instruction_master_limiter_cmd_src_data;                               // nios2_cpu_instruction_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         nios2_cpu_instruction_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> nios2_cpu_instruction_master_limiter:cmd_src_ready
	wire   [1:0] nios2_cpu_instruction_master_limiter_cmd_src_channel;                            // nios2_cpu_instruction_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire         nios2_cpu_instruction_master_limiter_cmd_src_startofpacket;                      // nios2_cpu_instruction_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire         nios2_cpu_instruction_master_limiter_cmd_src_endofpacket;                        // nios2_cpu_instruction_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire         rsp_mux_src_valid;                                                               // rsp_mux:src_valid -> nios2_cpu_instruction_master_limiter:rsp_sink_valid
	wire  [88:0] rsp_mux_src_data;                                                                // rsp_mux:src_data -> nios2_cpu_instruction_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                               // nios2_cpu_instruction_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [1:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> nios2_cpu_instruction_master_limiter:rsp_sink_channel
	wire         rsp_mux_src_startofpacket;                                                       // rsp_mux:src_startofpacket -> nios2_cpu_instruction_master_limiter:rsp_sink_startofpacket
	wire         rsp_mux_src_endofpacket;                                                         // rsp_mux:src_endofpacket -> nios2_cpu_instruction_master_limiter:rsp_sink_endofpacket
	...
	wire  [88:0] nios2_cpu_instruction_master_limiter_rsp_src_data;                               // nios2_cpu_instruction_master_limiter:rsp_src_data -> nios2_cpu_instruction_master_agent:rp_data
	...
	wire   [1:0] nios2_cpu_instruction_master_limiter_rsp_src_channel;                            // nios2_cpu_instruction_master_limiter:rsp_src_channel -> nios2_cpu_instruction_master_agent:rp_channel
	...
	wire   [1:0] nios2_cpu_instruction_master_limiter_cmd_valid_data;                             // nios2_cpu_instruction_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire         nios2_cpu_debug_mem_slave_agent_rdata_fifo_src_valid;                            // nios2_cpu_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] nios2_cpu_debug_mem_slave_agent_rdata_fifo_src_data;                             // nios2_cpu_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         nios2_cpu_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter:in_0_ready -> nios2_cpu_debug_mem_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                   // avalon_st_adapter:out_0_valid -> nios2_cpu_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                    // avalon_st_adapter:out_0_data -> nios2_cpu_debug_mem_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                   // nios2_cpu_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                   // avalon_st_adapter:out_0_error -> nios2_cpu_debug_mem_slave_agent:rdata_fifo_sink_error
	wire         sys_mem_s2_agent_rdata_fifo_src_valid;                                           // sys_mem_s2_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] sys_mem_s2_agent_rdata_fifo_src_data;                                            // sys_mem_s2_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         sys_mem_s2_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_001:in_0_ready -> sys_mem_s2_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                               // avalon_st_adapter_001:out_0_valid -> sys_mem_s2_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                // avalon_st_adapter_001:out_0_data -> sys_mem_s2_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                               // sys_mem_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                               // avalon_st_adapter_001:out_0_error -> sys_mem_s2_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (sys_clk_clk_clk),                            //                      clk.clk
		.reset                  (sys_mem_reset2_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (sys_clk_clk_clk),                             //             clk.clk
		.reset                   (sys_mem_reset2_reset_bridge_in_reset_reset),  //       clk_reset.reset
	...
	base_sys_mm_interconnect_1_router router (
	...
	base_sys_mm_interconnect_1_router_001 router_001 (
	...
	base_sys_mm_interconnect_1_router_001 router_002 (
	...
	base_sys_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (sys_clk_clk_clk),                                            //        clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	base_sys_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (sys_clk_clk_clk),                             //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_sys_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (sys_clk_clk_clk),                            //       clk.clk
		.reset               (sys_mem_reset2_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_sys_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (sys_clk_clk_clk),                             //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_sys_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (sys_clk_clk_clk),                            //       clk.clk
		.reset              (sys_mem_reset2_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_sys_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (sys_clk_clk_clk),                             //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	base_sys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (sys_clk_clk_clk),                            // in_clk_0.clk
		.in_rst_0_reset (sys_mem_reset2_reset_bridge_in_reset_reset), // in_rst_0.reset
